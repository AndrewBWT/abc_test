...
public:
     ...
     */
    __no_constexpr log_msg_itt_t
        add_log_msg(log_msg_ref_t _a_log, const ds::single_source_t& _a_source)
            noexcept;
    /*!
    ...
    __no_constexpr_or_inline void
        remove_log_msg(log_msg_itt_t _a_itt) noexcept;
    /*!
     ...
     */
    __no_constexpr_or_inline ds::log_infos_t
...
private:
    log_msg_ptrs_t           _m_current_log_msgs;
    std::vector<std::string> _m_cached_log_msgs;
    std::reference_wrapper<reporters::test_reporter_controller_t> _m_trc;
...
__no_constexpr_imp log_msg_itt_t
    test_runner_t::add_log_msg(
        log_msg_ref_t              _a_log,
        const ds::single_source_t& _a_source
    ) noexcept
{
    using namespace std;
