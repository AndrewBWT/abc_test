...
>
struct generic_manual_assertion_list_formatter_t
	: public list_formattable_t< reports::generic_manual_assertion_t<Single_Source, Assertion_Status>,
	combined_enum_generic_manual_assertion_fields_t, print_config_t>,
...
public:
	__constexpr
		...
		bool
		check_data(
			const combined_enum_generic_manual_assertion_fields_t& _a_fid,
			const reports::generic_manual_assertion_t<Single_Source, Assertion_Status>& _a_element
		) const override;
	__constexpr
		virtual
...
__constexpr_imp
bool
generic_manual_assertion_list_formatter_t<Single_Source,Assertion_Status>::check_data(
	const combined_enum_generic_manual_assertion_fields_t& _a_fid,
	const reports::generic_manual_assertion_t<Single_Source, Assertion_Status>& _a_element
) const
{
	using namespace std;
	if (auto _l_ptr{ get_if< enum_generic_manual_assertion_fields_t>(&_a_fid) };
		_l_ptr != nullptr)
	{
		switch (*_l_ptr)
		{
	...
	else if (auto _l_ptr{ get_if< combined_enum_generic_assertion_fields_t>(&_a_fid) };
		_l_ptr != nullptr)
	{
...
__constexpr_imp
std::vector<std::string>
generic_manual_assertion_list_formatter_t<Single_Source, Assertion_Status>::get_data(
	const combined_enum_generic_manual_assertion_fields_t& _a_fid,
	const reports::generic_manual_assertion_t<Single_Source, Assertion_Status>& _a_element,
	const print_config_t& _a_pc
) const
