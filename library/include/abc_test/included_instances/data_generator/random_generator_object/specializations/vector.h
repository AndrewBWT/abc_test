...
template <typename T>
struct random_generator_object_t<std::vector<T>>
{
public:
    __constexpr
...
template <typename T>
__constexpr_imp
random_generator_object_t<std::vector<T>>::random_generator_object_t(
    const std::shared_ptr<random_generator_object_t<T>>& _a_gen
) noexcept
    : _m_gen(_a_gen)
{}
...
random_generator_object_t<std::vector<T>>::operator()(
