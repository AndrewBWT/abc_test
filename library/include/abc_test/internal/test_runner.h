#pragma once
#include "abc_test/internal/ds/source/single_source.h"
...
#include "abc_test/internal/test_order_enum.h"
#include "abc_test/internal/test_reports/assertion.h"
#include "abc_test/internal/test_reports/basic_text_warning.h"
...
public:
     ...
     * generator.
     */
    __constexpr _ABC_NS_UTILITY::seed_t
...
private:
    ...
    std::unique_ptr<_ABC_NS_DS::invoked_test_data_t> _m_current_test;
...
__constexpr_imp _ABC_NS_UTILITY::seed_t
