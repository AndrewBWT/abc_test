...
)
{
    ...
    using namespace test::str;
    manual_data_generator_t _l_mdg;
    RUN(_l_mdg, coverage_test_basic_string<string>());
    RUN(_l_mdg, coverage_test_basic_string<wstring>());
    RUN(_l_mdg, coverage_test_basic_string<u8string>());
    RUN(_l_mdg, coverage_test_basic_string<u16string>());
    RUN(_l_mdg, coverage_test_basic_string<u32string>());
    RUN(_l_mdg, coverage_test_basic_string<basic_string<int>>());
}
