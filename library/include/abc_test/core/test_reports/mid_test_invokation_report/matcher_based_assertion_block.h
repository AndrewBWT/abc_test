...
struct matcher_based_assertion_block_t
	: public generic_matcher_based_assertion_t<false, Assertion_Status>
{
public:
	using generic_matcher_based_assertion_t<false, Assertion_Status>::generic_matcher_based_assertion_t;
};
_END_ABC_REPORTS_NS