 ...
 */
    template <>
struct fmt::formatter<abc::ds::enum_test_status_t> : formatter<string_view>
{
    /*!
     * Provides a formatter for a poset_setup_test_data_t object
     */
    __no_constexpr auto
        format(abc::ds::enum_test_status_t _a_iti, format_context& _a_cxt)
...
fmt::formatter<abc::ds::enum_test_status_t>::format(
    abc::ds::enum_test_status_t _a_iti,
...
) const -> format_context::iterator
{
    ...
    case TERMINATION_OCCOURED_UNEXPECTED_THROW:
        ...
        break;
    default:
        throw abc::errors::unaccounted_for_enum_exception(_a_iti);
    }
