...
std::variant< enum_matcher_based_assertion_fields_t, combined_enum_generic_matcher_based_assertion_fields_t>;
__constexpr
enum_print_pair_collection_t< combined_enum_matcher_based_assertion_fields_t>
default_matcher_based_assertion_fields(
) noexcept;
