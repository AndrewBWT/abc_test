...
public:
    ...
    __constexpr std::size_t
                total_tests_ran() const noexcept;
    __constexpr std::size_t
                total_tests_passed() const noexcept;
    __constexpr std::size_t
                total_tests_failed() const noexcept;
    __constexpr std::size_t
                total_tests_failed_and_terminated() const noexcept;
    __constexpr std::size_t
                total_tests_failed_but_not_terminated() const noexcept;
    __constexpr std::size_t
        total_tests_designated_failure_due_to_exception() const noexcept;
    __constexpr       std::size_t
                      total_assertions_ran() const noexcept;
    __constexpr       std::size_t
                      total_assertions_passed() const noexcept;
    __constexpr       std::size_t
                      total_assertions_failed() const noexcept;
    __constexpr const utility::complete_global_seed_t&
                      seed() const noexcept;
    ...
    {
        T _l_opt = *(static_cast<const T*>(&global::get_this_threads_test_options()));
...
__constexpr_imp std::size_t
                finalised_test_set_data_t::total_tests_ran() const noexcept
{
    return _m_total_tests_ran;
}

__constexpr_imp std::size_t
                finalised_test_set_data_t::total_tests_passed() const noexcept
{
    return _m_total_tests_passed;
}

__constexpr_imp std::size_t
                finalised_test_set_data_t::total_tests_failed() const noexcept
{
...
__constexpr_imp std::size_t
                finalised_test_set_data_t::total_assertions_ran() const noexcept
{
    return _m_total_assertions_ran;
}

__constexpr_imp std::size_t
    finalised_test_set_data_t::total_assertions_passed() const noexcept
{
    return _m_total_assertions_passed;
}

__constexpr_imp std::size_t
    finalised_test_set_data_t::total_assertions_failed() const noexcept
{
    return _m_total_assertions_failed;
}

__constexpr_imp const utility::complete_global_seed_t&
                      finalised_test_set_data_t::seed() const noexcept
{
    return _m_seed;
}

__constexpr_imp const abc::ds::map_unique_id_to_tdg_collection_stack_trie_t&
    finalised_test_set_data_t::map_ids_to_tdg_collection_stack_tries(
    ) const noexcept
{
