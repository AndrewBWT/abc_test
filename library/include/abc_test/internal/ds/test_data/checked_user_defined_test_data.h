#pragma once
#include "abc_test/internal/ds/test_data/user_defined_test_data.h"
...
template <>
struct fmt::formatter<_ABC_NS_DS::checked_user_defined_test_data_t>
    : formatter<string_view>
{
    ...
    __no_constexpr auto
        format(
            _ABC_NS_DS::checked_user_defined_test_data_t _a_rtd,
...
__no_constexpr_imp auto
    fmt::formatter<_ABC_NS_DS::checked_user_defined_test_data_t>::format(
        _ABC_NS_DS::checked_user_defined_test_data_t _a_rtd,
        format_context&                           _a_ctx
    ) const -> format_context::iterator
{
