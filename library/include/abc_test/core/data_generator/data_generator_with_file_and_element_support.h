 ...
 */
template <typename T, typename Rep_Data, bool Supports_General_Data_File_IO, bool Supports_Rep_Data_File_IO>
class data_generator_with_file_support_and_element_storage_t
    : public data_generator_with_file_support_t<T, Rep_Data,Supports_General_Data_File_IO,Supports_Rep_Data_File_IO>
{
public:
    /*!
     * @brief Constructor
...
template <typename R>
__constexpr
data_generator_with_file_support_and_element_storage_t<T, Rep_Data>::
    data_generator_with_file_support_and_element_storage_t(
        const size_t                              _a_elements_generated,
        const utility::io::opt_file_rw_info_t<T>& _a_core_data_rw_info,
        R&&                                       _a_elements,
    ...
    : data_generator_with_file_support_t<T, Rep_Data,Supports_General_Data_File_IO,Supports_Rep_Data_File_IO>(
