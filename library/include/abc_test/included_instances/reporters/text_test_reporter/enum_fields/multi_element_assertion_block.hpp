...
using combined_enum_multi_element_assertion_block_fields_t =
std::variant< enum_multi_element_assertion_block_fields_t, combined_enum_assertion_fields_t>;
__constexpr
enum_print_pair_collection_t< combined_enum_multi_element_assertion_block_fields_t>
