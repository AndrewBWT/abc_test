...
template <>
struct fmt::formatter<abc::ds::single_source_t> : formatter<string_view>
{
    // parse is inherited from formatter<string_view>.
    // Can'tbe constexpr due to use of fmt::format
    __no_constexpr auto
        format(abc::ds::single_source_t _a_rtd, format_context& _a_ctx) const
...
__no_constexpr_imp auto
    fmt::formatter<abc::ds::single_source_t>::format(
        abc::ds::single_source_t _a_rtd,
