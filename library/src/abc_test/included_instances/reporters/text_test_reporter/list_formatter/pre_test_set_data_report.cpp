    ...
    ) const
{
    ...
    if (_a_element.get_options().show_configuration_explanations)
    {
        ...
        case USE_GLOBAL_TEST_LIST:
            return {
                "",
                _a_pc.highlight(_a_pc.use_global_test_list_info(
        ...
        case WRITE_DATA_TO_FILES:
            return {
                "",
                _a_pc.highlight(_a_pc.write_data_to_files_info(
        ...
        case PATH_DELIMITER:
            return {
                "",
                _a_pc.highlight(_a_pc.path_delimiter_used_info(
        ...
        case GENERAL_DATA_FILE_EXTENSION:
            return {
                "",
                _a_pc.highlight(_a_pc.general_data_file_extension_info(
        ...
        case N_INTEGERS_USED_FOR_CREATION_OF_RNG:
            return {
                "",
                _a_pc.highlight(_a_pc.n_integers_used_for_creation_of_rng_info(
        ...
        case REPETITION_CONFIG_USED:
            return {
                "",
                _a_pc.highlight(_a_pc.repetition_config_used_info())
            };
        case GLOBAL_SEED:
        ...
        case FORCE_RUN_ALL_TESTS:
            return {
                "",
                _a_pc.highlight(_a_pc.force_run_all_tests_info(
        ...
        case TEST_PATHS_TO_RUN:
            return {
                "",
                _a_pc.highlight(_a_pc.test_paths_to_run_info(
    ...
    ) const
{
    ...
    case GLOBAL_SEED:
        ...
        return {
            ...
            _a_pc.print_global_seed(_a_element.get_options().global_seed,
    ...
    ) const
{
    ...
    vector<string> _l_rv{get_output(_a_fid, _a_element, _a_pc)};
    _l_rv.append_range(get_explanation_data(_a_fid, _a_element, _a_pc));
    _l_rv.append_range(get_cli_info(_a_fid, _a_element, _a_pc));
    return _l_rv;
}
