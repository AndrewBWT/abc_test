...
Global seed:                        Not set by user. Global seed has been set randomly by system to the integer 1752780030
...
==========================================================================================
  1)  Multi-element block-based assertion failed. 2/3 assertions passed. Assertion terminated function.
      ...
      Source block begin:
        ...
        Source location:
          G:\MyProjects\cpp\git_projects\abc_test\examples\include\abc_test_examples/readme.hpp:43
        Source code representation:
          "_CHECK"
