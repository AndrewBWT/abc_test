...
("enum `anonymous namespace'::enum_with_enum_list_1", {true})
("enum `anonymous namespace'::enum_with_enum_list_2", {true})
("enum `anonymous namespace'::enum_no_enum_list", {false})
